...
import { closeLocationStore, connectLocationStore, getVehicleLocation, saveVehicleLocation, } from './modules/vehicles/vehicle-location.service.js';
dotenv.config();
...
io.on('connection', (socket) => {
    ...
    socket.on('vehicle:subscribe', async (vehicleId) => {
    ...
    socket.on('vehicle:unsubscribe', async (vehicleId) => {
        if (typeof vehicleId === 'string' && vehicleId.length > 0) {
